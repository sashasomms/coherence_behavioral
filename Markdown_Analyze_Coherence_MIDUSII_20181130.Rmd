---
title: "Analysis of Stress-Heart Rate Coherence & Well-Being"
...
Then processed through Prep_Coherence_MIDUSII.R script. Find at:  
github.com/sashasomms/coherence_behavioral/
...
```
### Siblings
```{r sortout_siblings, include=FALSE}
# Twins
...
```{r individual_slopes, fig.width=7, fig.height=6}
...
```{r individual_slopes_heat_map, fig.width=7, fig.height=6}
...
```{r blupHist, fig.width=5, fig.height=4}
...
## Multiple Comparisons Correction
Holm-Bonferonni
```{r multiple_comparisons_correlations}
...
```{r stress_reactivity_hr_reactivity } 
...
```{r depression_coherence_reactivity}
# CESD
...
### Anxiety + reactivity
```{r anxiety_coherence_reactivity}
# P4_STAItrait
...
### Depression + recovery 
```{r depression_coherence_recovery}
# CESD
...
```{r pwb_coherence_reactivity_recovery}
# PWB
...
```{r depression_coherence_reactivity_recovery}
# CESD
...
```{r anxiety_coherence_reactivity_recovery}
# P4_STAItrait
...
```{r IL6_coherence_reactivity_recovery}
# IL6
...
```{r CRP_coherence_reactivity_recovery}
# CRP
...
```{r denial_coherence_reactivity_recovery}
# Denial
...
### Depression ~ reactivity + recovery
```{r depression_reactivity_recovery}
# CESD
