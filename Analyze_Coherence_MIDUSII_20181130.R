...
# Run the test 
lmerM = lmer(hr ~ stress_CMC * COPE_denial_C + P4_age_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLs)
#Anova(lmerM, type=3, test="F")
...
p = c(1.17E-05, 1.16E-07, 6.37E-07, 5.58E-07, 0.0117, 4.27E-06)
## Holm-bonferonni
p.adjust(p, method= 'holm')
# 2.340e-05 6.960e-07 2.790e-06 2.790e-06 1.170e-02 1.281e-05
...
ggplot(dfL, aes(stress, hr, color=coherence_slope))+
  ...
  scale_x_continuous("Stress", breaks = seq(0, 10, by=1))
...
# II. Reactivity/Reactance and Recovery
...
### Heart rate reactivity 
lmerM = lmer(hr ~ stress_CMC * hrChangeStresstoBase_C + P4_age_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLsRR)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
...
### Stress reactivity
lmerM = lmer(hr ~ stress_CMC * stressChangeStresstoBase_C + P4_age_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLsRR)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLsRR) 
glance_obj = broom.mixed::glance(lmerM)
...
### Heart rate recovery
lmerM = lmer(hr ~ stress_CMC * hrChangeRecovtoStress_C + P4_age_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLsRR)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLsRR) 
glance_obj = broom.mixed::glance(lmerM)
...
### Stress recovery
lmerM = lmer(hr ~ stress_CMC * stressChangeRecovtoStress_C + P4_age_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLsRR)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLsRR) 
glance_obj = broom.mixed::glance(lmerM)
...
### PWB + reactivity
lmerM = lmer(hr ~ stress_CMC * pwb2_C + P4_age_C + stressChangeStresstoBase_C + hrChangeStresstoBase_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLsRR)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLsRR) 
glance_obj = broom.mixed::glance(lmerM)
...
lmerM = lmer(hr ~ stress_CMC * P4_CESD_C + P4_age_C + stressChangeStresstoBase_C + hrChangeStresstoBase_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLsRR)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLsRR) 
glance_obj = broom.mixed::glance(lmerM)
...
### Anxiety + reactivity
# P4_STAItrait
lmerM = lmer(hr ~ stress_CMC * P4_STAItrait_C + P4_age_C + stressChangeStresstoBase_C + hrChangeStresstoBase_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLsRR)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLsRR) 
glance_obj = broom.mixed::glance(lmerM)
...
### IL6 + reactivity
lmerM = lmer(hr ~ stress_CMC * IL6_T_C + P4_age_C + stressChangeStresstoBase_C + hrChangeStresstoBase_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLsRR)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLsRR) 
glance_obj = broom.mixed::glance(lmerM)
...
### CRP + reactivity
lmerM = lmer(hr ~ stress_CMC * CRP_T_C + P4_age_C + stressChangeStresstoBase_C + hrChangeStresstoBase_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLsRR)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLsRR) 
glance_obj = broom.mixed::glance(lmerM)
...
### Denial + reactivity
lmerM = lmer(hr ~ stress_CMC * COPE_denial_C + P4_age_C + stressChangeStresstoBase_C + hrChangeStresstoBase_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLsRR)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLsRR) 
glance_obj = broom.mixed::glance(lmerM)
...
### PWB + recovery
lmerM = lmer(hr ~ stress_CMC * pwb2_C + P4_age_C + stressChangeRecovtoStress_C + hrChangeRecovtoStress_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLsRR)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLsRR) 
glance_obj = broom.mixed::glance(lmerM)
...
### Depression + recovery 
# CESD
lmerM = lmer(hr ~ stress_CMC * P4_CESD_C + P4_age_C + stressChangeRecovtoStress_C + hrChangeRecovtoStress_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLsRR)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLsRR) 
glance_obj = broom.mixed::glance(lmerM)
...
### Anxiety + recovery
# P4_STAItrait
lmerM = lmer(hr ~ stress_CMC * P4_STAItrait_C + P4_age_C + stressChangeRecovtoStress_C + hrChangeRecovtoStress_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLsRR)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLsRR) 
glance_obj = broom.mixed::glance(lmerM)
...
### IL6 + recovery
lmerM = lmer(hr ~ stress_CMC * IL6_T_C + P4_age_C + stressChangeRecovtoStress_C + hrChangeRecovtoStress_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLsRR)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLsRR) 
glance_obj = broom.mixed::glance(lmerM)
...
### CRP + recovery
lmerM = lmer(hr ~ stress_CMC * CRP_T_C + P4_age_C + stressChangeRecovtoStress_C + hrChangeRecovtoStress_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLsRR)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLsRR) 
glance_obj = broom.mixed::glance(lmerM)
...
### denial + recovery
lmerM = lmer(hr ~ stress_CMC * COPE_denial_C + P4_age_C + stressChangeRecovtoStress_C + hrChangeRecovtoStress_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLsRR)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLsRR) 
glance_obj = broom.mixed::glance(lmerM)
...
lmerM = lmer(hr ~ stress_CMC * pwb2_C + P4_age_C + stressChangeStresstoBase_C + hrChangeStresstoBase_C + stressChangeRecovtoStress_C + hrChangeRecovtoStress_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLsRR)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLsRR) 
glance_obj = broom.mixed::glance(lmerM)
...
# CESD
lmerM = lmer(hr ~ stress_CMC * P4_CESD_C + P4_age_C + stressChangeStresstoBase_C + hrChangeStresstoBase_C + stressChangeRecovtoStress_C + hrChangeRecovtoStress_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLsRR)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLsRR) 
glance_obj = broom.mixed::glance(lmerM)
...
# P4_STAItrait
lmerM = lmer(hr ~ stress_CMC * P4_STAItrait_C + P4_age_C + stressChangeStresstoBase_C + hrChangeStresstoBase_C + stressChangeRecovtoStress_C + hrChangeRecovtoStress_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLsRR)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLsRR) 
glance_obj = broom.mixed::glance(lmerM)
...
lmerM = lmer(hr ~ stress_CMC * IL6_T_C + P4_age_C + stressChangeStresstoBase_C + hrChangeStresstoBase_C + stressChangeRecovtoStress_C + hrChangeRecovtoStress_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLsRR)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLsRR) 
glance_obj = broom.mixed::glance(lmerM)
...
lmerM = lmer(hr ~ stress_CMC * CRP_T_C + P4_age_C + stressChangeStresstoBase_C + hrChangeStresstoBase_C + stressChangeRecovtoStress_C + hrChangeRecovtoStress_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLsRR)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLsRR) 
glance_obj = broom.mixed::glance(lmerM)
...
lmerM = lmer(hr ~ stress_CMC * COPE_denial_C + P4_age_C + stressChangeStresstoBase_C + hrChangeStresstoBase_C + stressChangeRecovtoStress_C + hrChangeRecovtoStress_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLsRR)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLsRR) 
glance_obj = broom.mixed::glance(lmerM)
...
# III. Lag from Survey to Biomarker substudies
...
# Lag moderate?
lmerM = lmer(hr ~ stress_CMC * pwb2_C * months_P1SAQ_to_P4_C + P4_age_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLs)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLs) 
glance_obj = broom.mixed::glance(lmerM)
...
# Lag moderate?
lmerM = lmer(hr ~ stress_CMC * COPE_denial_C * months_P1SAQ_to_P4_C + P4_age_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLs)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLs) 
glance_obj = broom.mixed::glance(lmerM)
...
### Autonomy 
lmerM = lmer(hr ~ stress_CMC * autonomy2_C + P4_age_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLs)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLs) 
glance_obj = broom.mixed::glance(lmerM)
...
lmerM = lmer(hr ~ stress_CMC * envMast2_C + P4_age_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLs)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLs) 
glance_obj = broom.mixed::glance(lmerM)
...
### Personal Growth
lmerM = lmer(hr ~ stress_CMC * persGrow2_C + P4_age_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLs)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLs) 
glance_obj = broom.mixed::glance(lmerM)
...
lmerM = lmer(hr ~ stress_CMC * posRela2_C + P4_age_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLs)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLs) 
glance_obj = broom.mixed::glance(lmerM)
...
### Purpose in Life
lmerM = lmer(hr ~ stress_CMC * purpLife2_C + P4_age_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLs)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLs) 
glance_obj = broom.mixed::glance(lmerM)
...
### Self Acceptance
lmerM = lmer(hr ~ stress_CMC * selfAcce2_C + P4_age_C + (1+ stress_CMC|M2ID) + (1|M2FAMNUM), data=dfLs)
#Anova(lmerM, type=3, test="F")
modelSummary(lmerM, t = FALSE)
table_obj = broom.mixed::tidy(lmerM, conf.int=TRUE, conf.level=.95, conf.method="Wald", effects = c("ran_pars", "fixed"), data=dfLs) 
glance_obj = broom.mixed::glance(lmerM)
